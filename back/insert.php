...
//*
$target_ID = intval($_POST['id_prod']);
$target_nombre = $_POST['namae'];
$target_comp = $_POST['comp'];
$target_prec = intval($_POST['prec']);
$target_exis = intval($_POST['exis']);
$target_preOfer = intval($_POST['PreOfer']);
$target_ofer = $_POST['oferta'];
$target_garan = intval($_POST['garan']);
